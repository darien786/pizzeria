...
export default function Products() {
    ...
    const promotions = [
        { image: "./img/cards/card-pizza.jpg", name: "Combo Hawaiana y Peperoni", price: "$190" },
        { image: "./img/cards/card-pizza.jpg", name: "Combo Hawaiana y 3 Quesos", price: "$190" },
        { image: "./img/cards/card-burger.jpg", name: "2 Hamburguesas Mega Especial y una orden de papas ", price: "$150" },
        { image: "./img/cards/card-hotdog.jpg", name: "3 Hot Dogs Hawaianos con Tocino", price: "$75" },
        { image: "./img/cards/card-frappe.jpg", name: "2 Frappe's (Oreo, Moca, Café, Clicle, Fresa, Mazapan o Nutella)", price: "$280" },
        { image: "./img/cards/card-alitas.jpg", name: "10 Alitas, Papas a la Francesa y Jugo Boing o Arizona", price: "$300" },
    ];
    ...
    return (
        <section className={styles.products}>
            <p className={styles.title}>Pizzas</p>
