            ...
            <div className={styles.container}>
                ...
                <div className={styles.services}>
                    <div className={styles.shopping}>
                        ...
                        <img src="./img/icons/food-delivery.png" alt="Imagen de envíos" width={300}/>
                    ...
                    <div className={styles.payment}>
                        ...
                        <img src="./img/icons/online-banking.png" alt="Imagen de medios de pago" width={300}/>
                    ...
                    <div className={styles.schedule}>
                        ...
                        <img src="./img/icons/clock.png" alt="Imagen de reloj" width={300}/>
